...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Immobilier</a>
      </li>
    </ul>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Lites des dossiers Immobilier</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Acceuill</a></li>
              <li class="breadcrumb-item active">Dossier/Immobilier</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <tr>
                    <td>DOSSIER/008/022</td>
                    <td>22/10/2020</td>
                    <td>Ange</td>
                    <td>Immobilier</td>
                    <td style="background-color:red;color:#fff">Nouveau</td>
                  </tr>

                  <tr>
                    <td>DOSSIER/010/022</td>
                    <td>22/10/2020</td>
                    <td>Ange</td>
                    <td>Immobilier</td>
                    <td style="background-color:red;color:#fff">Nouveau</td>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2019 <a href="http://adminlte.io">Notarium</a>.</strong> All rights
    reserved.
  </footer>
